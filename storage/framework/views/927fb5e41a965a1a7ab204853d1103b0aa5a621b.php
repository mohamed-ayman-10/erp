            ...
            <ul class="dash-navbar">
                ...
                <?php if(Gate::check('show hrm dashboard') || Gate::check('show project dashboard') || Gate::check('show account dashboard')): ?>
                    <li
                        ...
                        <a href="#!" class="dash-link "><span class="dash-micon"><i
                                    class="ti ti-home"></i></span><span class="dash-mtext"><?php echo e(__('Dashboard')); ?></span>
                        ...
                        <ul class="dash-submenu">
                            <?php if(\Auth::user()->show_account() == 1 && Gate::check('show account dashboard')): ?>
                                <li
                                    class="dash-item dash-hasmenu <?php echo e(Request::segment(1) == null || Request::segment(1) == 'account-dashboard' || Request::segment(1) == 'report' ? ' active dash-trigger' : ''); ?>">
                                            ...
                                            <li
                                                ...
                                                <ul class="dash-submenu">
                                                    ...
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('loss & profit report')): ?>
                                                        <li
                                                            class="dash-item <?php echo e(Request::route()->getName() == 'report.profit.loss.summary' ? ' active' : ''); ?>">
                                                            <a class="dash-link"
                                                                href="<?php echo e(route('report.profit.loss.summary')); ?>"><?php echo e(__('Profit & Loss')); ?></a>
                                                        </li>
                                                    <?php endif; ?>
                    ...
                    <?php if(Gate::check('manage employee') || Gate::check('manage setsalary')): ?>
                        <li
                            ...
                            <a href="#!" class="dash-link "><span class="dash-micon"><i
                                    ...
                                    class="dash-mtext"><?php echo e(__('HRM System')); ?></span><span class="dash-arrow">
                        ...
                        <li
                            ...
                            <ul class="dash-submenu">
                                ...
                                <?php if(Gate::check('manage invoice') || Gate::check('manage revenue') || Gate::check('manage credit note')): ?>
                                    <li
                                        class="dash-item dash-hasmenu <?php echo e(Request::segment(1) == 'invoice' || Request::segment(1) == 'revenue' || Request::segment(1) == 'credit-note' ? 'active dash-trigger' : ''); ?>">
                                ...
                                <?php if(Gate::check('manage bill') || Gate::check('manage payment') || Gate::check('manage debit note')): ?>
                                    <li
                                        class="dash-item dash-hasmenu <?php echo e(Request::segment(1) == 'bill' || Request::segment(1) == 'payment' || Request::segment(1) == 'debit-note' ? 'active dash-trigger' : ''); ?>">
                                ...
                                <?php if(Gate::check('manage chart of account') ||
                                    ...
                                    <li
                                        ...
                                        <ul class="dash-submenu">
                                            <li
                                                class="dash-item <?php echo e(Request::route()->getName() == 'chart-of-account.index' ? ' active' : ''); ?>">
                                                <a class="dash-link"
                ...
                <?php if(\Auth::user()->show_crm() == 1): ?>
                    <?php if(Gate::check('manage lead') ||
                        ...
                        <li
                            class="dash-item dash-hasmenu
                                        <?php echo e(Request::segment(1) == 'stages' ||
                            ...
                            <ul class="dash-submenu">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage timesheet')): ?>
                                    <li class="dash-item <?php echo e(request()->is('timesheet-list*') ? 'active' : ''); ?>">
                                        <a class="dash-link"
                                            href="<?php echo e(route('timesheet.list')); ?>"><?php echo e(__('Timesheet')); ?></a>
                                    </li>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage bug report')): ?>
                                    <li class="dash-item <?php echo e(request()->is('bugs-report*') ? 'active' : ''); ?>">
                                        <a class="dash-link"
                                            href="<?php echo e(route('bugs.view', 'list')); ?>"><?php echo e(__('Bug')); ?></a>
                                    </li>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage project task')): ?>
                                ...
                                <?php if(\Auth::user()->type != 'super admin'): ?>
                                    <li
                                        class="dash-item  <?php echo e(Request::segment(1) == 'time-tracker' ? 'active open' : ''); ?>">
                                        <a class="dash-link"
                                            href="<?php echo e(route('time.tracker')); ?>"><?php echo e(__('Tracker')); ?></a>
                                    </li>
                                <?php endif; ?>
                ...
                <?php if(
                    ...
                    <li class="dash-item dash-hasmenu">
                        <a href="#!"
                            class="dash-link <?php echo e(Request::segment(1) == 'users' || Request::segment(1) == 'roles' || Request::segment(1) == 'clients' ? ' active dash-trigger' : ''); ?>"><span
                        ...
                        <li
                            ...
                            <a href="#!" class="dash-link"><span class="dash-micon"><i
                                    ...
                                    class="dash-mtext"><?php echo e(__('POS System')); ?></span><span class="dash-arrow"><i
                                        data-feather="chevron-right"></i></span></a>
                            <ul
                                class="dash-submenu <?php echo e(Request::segment(1) == 'warehouse' || Request::segment(1) == 'purchase' || Request::route()->getName() == 'pos.barcode' || Request::route()->getName() == 'pos.print' || Request::route()->getName() == 'pos.show' ? 'show' : ''); ?>">
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage warehouse')): ?>
                                    <li
                                        ...
                                        <a class="dash-link"
                                            href="<?php echo e(route('warehouse.index')); ?>"><?php echo e(__('Warehouse')); ?></a>
                                    </li>
                                <?php endif; ?>
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage pos')): ?>
                                    <li
                                        class="dash-item <?php echo e(Request::route()->getName() == 'pos.index' ? ' active' : ''); ?>">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create barcode')): ?>
                                    <li
                                        ...
                                        <a class="dash-link"
                                            href="<?php echo e(route('pos.barcode')); ?>"><?php echo e(__('Print Barcode')); ?></a>
                                    </li>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage pos')): ?>
                                    <li
                        ...
                        <li class="dash-item dash-hasmenu">
                            <a href="#!" class="dash-link ">
                                <span class="dash-micon"><i class="ti ti-settings"></i></span><span
                                    class="dash-mtext"><?php echo e(__('Settings')); ?></span><span class="dash-arrow">
                                    <i data-feather="chevron-right"></i></span>
                            </a>
                            <ul class="dash-submenu">
...
<?php /**PATH C:\laragon\www\erpgo\resources\views/partials/admin/menu.blade.php ENDPATH**/ ?>