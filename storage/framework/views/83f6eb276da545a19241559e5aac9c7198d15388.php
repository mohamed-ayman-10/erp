                            ...
                            <div data-v-f2a183a6="" class="d-header" style="background: <?php echo e($color); ?>;color:<?php echo e($font_color); ?>">
                                <div data-v-f2a183a6="" class="d-header-inner">
                                    ...
                                    <div data-v-f2a183a6="" class="d-header-50 d-right">
                                        <div data-v-f2a183a6="" class="d-title "><?php echo e(__('Purchase')); ?></div>
                                        <table data-v-f2a183a6="" class="summary-table">
                                            <tbody data-v-f2a183a6="">
                                            <tr>
                                                <td><?php echo e(__('Number')); ?>:</td>
                                                <td><?php echo e(Utility::purchaseNumberFormat($settings,$purchase->purchase_id)); ?></td>
                                            </tr>
                                            <tr>
                                                <td><?php echo e(__('Purchase Date')); ?>:</td>
                                                <td><?php echo e(Utility::dateFormat($settings,$purchase->purchase_date)); ?></td>
                                            </tr>
                                    ...
                                    <div data-v-f2a183a6="" class="d-table">
                                        <div data-v-f2a183a6="" class="d-table">
                                            ...
                                            <div data-v-f2a183a6="" class="d-table-tr" style="background: <?php echo e($color); ?>;color:<?php echo e($font_color); ?>">
                                                ...
                                                <div class="d-table-th w-4"><?php echo e(__('Rate')); ?></div>
                                            ...
                                            <div class="d-table-tr" style="border-bottom:1px solid <?php echo e($color); ?>;">
                                                ...
                                                <div class="d-table-td w-3">
                                                    <pre data-v-f2a183a6=""><?php echo e($purchase->totalQuantity); ?></pre>
                                                </div>
                                                <div class="d-table-td w-4">
                                                    <pre data-v-f2a183a6=""><?php echo e(Utility::priceFormat($settings,$purchase->totalRate)); ?></pre>
                                                </div>
                                                <div class="d-table-td w-5">
                                                    <pre data-v-f2a183a6=""><?php echo e(Utility::priceFormat($settings,$purchase->totalTaxPrice)); ?></pre>
                                                </div>

                                                    <div class="d-table-td w-4">
                                                        <pre data-v-f2a183a6=""><?php echo e(Utility::priceFormat($settings,$purchase->totalDiscount)); ?></pre>
                                                    </div>


                                                <div class="d-table-td w-4 ">
                                                    <span><?php echo e(Utility::priceFormat($settings,$purchase->getSubTotal())); ?>
                                            ...
                                            <div data-v-f2a183a6="" class="d-table-footer">
                                                ...
                                                <div data-v-f2a183a6="" class="d-table-summary">
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        ...
                                                        <div data-v-f2a183a6="" class="d-table-value"><?php echo e(Utility::priceFormat($settings,$purchase->getSubTotal())); ?></div>
                                                    </div>
                                                    <?php if($purchase->getTotalDiscount()): ?>
                                                        <div data-v-f2a183a6="" class="d-table-summary-item">
                                                            <div data-v-f2a183a6="" class="d-table-label"><?php echo e(__('Discount')); ?>:</div>
                                                            <div data-v-f2a183a6="" class="d-table-value"><?php echo e(Utility::priceFormat($settings,$purchase->getTotalDiscount())); ?></div>
                                                        </div>
                                                    <?php endif; ?>
                                                    ...
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        ...
                                                        <div data-v-f2a183a6="" class="d-table-value"><?php echo e(Utility::priceFormat($settings,$purchase->getSubTotal()-$purchase->getTotalDiscount()+$purchase->getTotalTax())); ?></div>
                                                    </div>
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        <div data-v-f2a183a6="" class="d-table-label"><?php echo e(__('Paid')); ?>:</div>
                                                        <div data-v-f2a183a6="" class="d-table-value"><?php echo e(Utility::priceFormat($settings,($purchase->getTotal()-$purchase->getDue()))); ?></div>
                                                    </div>

                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        <div data-v-f2a183a6="" class="d-table-label"><?php echo e(__('Due Amount')); ?>:</div>
                                                        <div data-v-f2a183a6="" class="d-table-value"><?php echo e(Utility::priceFormat($settings,$purchase->getDue())); ?></div>
                                                    </div>
                                                </div>
                                            </div>
...
<?php /**PATH C:\Users\Bdrango\Desktop\main_file\resources\views/purchase/templates/template1.blade.php ENDPATH**/ ?>