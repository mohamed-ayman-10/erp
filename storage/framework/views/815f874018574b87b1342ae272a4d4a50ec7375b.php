        ...
        <div class="row">
            <div class="col-12">
                <div class="mt-2 pos-top-bar bg-color d-flex justify-content-between">
                    ...
                    <a  href="<?php echo e(route('dashboard')); ?>" class="text-white"><i class="ti ti-home" style="font-size: 20px;"></i> </a>
                </div>
            </div>
        </div>
        <div class="mt-2 row">
                                            ...
                                            <?php $__currentLoopData = session($lastsegment); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $details): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                ?>
                                                    <tr data-product-id="<?php echo e($id); ?>" id="product-id-<?php echo e($id); ?>">
                                                        ...
                                                        <td class="price text-right"><?php echo e(Auth::user()->priceFormat($details['price'])); ?></td>
                                                        <td class="col-sm-3 mt-2">
                                                            <span class="subtotal"><?php echo e(Auth::user()->priceFormat($details['subtotal'])); ?></span>
                                                        </td>

                                                        <td class="col-sm-2 mt-2">
                                                            <a href="#" class="action-btn bg-danger bs-pass-para-pos" data-confirm="<?php echo e(__('Are You Sure?')); ?>" data-text="<?php echo e(__('This action can not be undone. Do you want to continue?')); ?>"
                                ...
                                <div class="total-section mt-3">
                                    <div class="sub-total">
                                        <div class="d-flex text-end justify-content-end">
                                            ...
                                            <h6 class="mb-0 text-dark subtotal_price" id="displaytotal"><?php echo e(Auth::user()->priceFormat($total)); ?></h6>
                                        </div>
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-6">
                                                <div class="d-flex align-items-center justify-content-end">
                                                    ...
                                                    <h6 class="totalamount" ><?php echo e(Auth::user()->priceFormat($total)); ?></h6>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-center justify-content-between pt-3" id="btn-pur">
                                            <button type="button" class="btn btn-primary rounded"  data-ajax-popup="true" data-size="xl"
                                                    data-align="centered" data-url="<?php echo e(route('pos.create')); ?>" data-title="<?php echo e(__('POS Invoice')); ?>"
                                            ...
                                            <div class="tab-content btn-empty text-end">
                                                <a href="#" class="btn btn-danger bs-pass-para-pos rounded m-0"  data-toggle="tooltip" data-original-title="<?php echo e(__('Empty Cart')); ?>"
...
<?php /**PATH C:\Users\Bdrango\Desktop\main_file\resources\views/pos/index.blade.php ENDPATH**/ ?>