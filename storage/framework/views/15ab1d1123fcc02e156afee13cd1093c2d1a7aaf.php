                            ...
                            <div data-v-f2a183a6="" class="d-header" style="background: <?php echo e($color); ?>;color:<?php echo e($font_color); ?>">
                                <div data-v-f2a183a6="" class="d-header-inner">
                                    ...
                                    <div data-v-f2a183a6="" class="d-header-50 d-right">
                                        <div data-v-f2a183a6="" class="d-title "><?php echo e(__('POS')); ?></div>
                                        <table data-v-f2a183a6="" class="summary-table">
                                            <tbody data-v-f2a183a6="">
                                            <tr>
                                                <td><?php echo e(__('Number')); ?>:</td>
                                                <td><?php echo e(Utility::posNumberFormat($settings,$pos->pos_id)); ?></td>
                                            </tr>
                                            <tr>
                                                <td><?php echo e(__('POS Date')); ?>:</td>
                                                <td><?php echo e(Utility::dateFormat($settings,$pos->pos_date)); ?></td>
                                            </tr>
                                ...
                                <div data-v-f2a183a6="" class="d-bill-to">
                                    ...
                                    <div data-v-f2a183a6="" class="d-table">
                                        <div data-v-f2a183a6="" class="d-table">
                                                ...
                                                <?php if(isset($pos->itemData) && count($pos->itemData) > 0): ?>
                                                    <?php $__currentLoopData = $pos->itemData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="d-table-tr" style="border-bottom:1px solid <?php echo e($color); ?>;">
                                                            <div class="d-table-td w-4"><pre data-v-f2a183a6=""><?php echo e($item->name); ?></pre></div>
                                                            <div class="d-table-td w-3"><pre data-v-f2a183a6=""><?php echo e($item->quantity); ?></pre></div>
                                                            <div class="d-table-td w-4 "><pre data-v-f2a183a6=""><?php echo e(Utility::priceFormat($settings,$item->price)); ?></pre></div>
                                                            ...
                                                            <div class="d-table-td w-4"><span><?php echo e(Utility::priceFormat($settings,$totalTaxPrice)); ?></span></div>
                                                            <div class="d-table-td w-4"><span><?php echo e(Utility::priceFormat($settings,$item->price +$totalTaxPrice)); ?></span></div>
                                                        </div>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                <?php else: ?>
                                                    <div class="d-table-tr" style="border-bottom:1px solid <?php echo e($color); ?>;">
                                            ...
                                            <div class="d-table-tr" style="border-bottom:1px solid <?php echo e($color); ?>;">
                                                <div class="d-table-td w-4"><pre data-v-f2a183a6=""><?php echo e(__('Total')); ?></pre></div>
                                                <div class="d-table-td w-3"><pre data-v-f2a183a6=""><?php echo e($pos->totalQuantity); ?></pre></div>
                                                <div class="d-table-td w-4"><pre data-v-f2a183a6=""><?php echo e(Utility::priceFormat($settings,$pos->totalRate)); ?></pre></div>
                                                <div class="d-table-td w-5"><pre data-v-f2a183a6="">-</pre></div>
                                                <div class="d-table-td w-4"><pre data-v-f2a183a6=""><?php echo e(Utility::priceFormat($settings,$pos->totalTaxPrice)); ?></pre></div>
                                                <div class="d-table-td w-4"><span><?php echo e(Utility::priceFormat($settings,$pos->totalRate + $pos->totalTaxPrice)); ?></span></div>
                                            </div>
                                            ...
                                            <div class="d-table-tr" style="border-bottom:1px solid <?php echo e($color); ?>;">
                                                ...
                                                <div class="d-table-td w-4"><pre data-v-f2a183a6=""></pre></div>
                                                <div class="d-table-td w-5"><pre data-v-f2a183a6=""></pre></div>
                                                <div class="d-table-td w-4"><pre data-v-f2a183a6=""><?php echo e(__('Sub Total')); ?></pre></div>
                                                <div class="d-table-td w-4"><span><?php echo e(Utility::priceFormat($settings,$pos->totalRate + $pos->totalTaxPrice)); ?></span></div>
                                            </div>
                                            ...
                                            <div class="d-table-tr" style="border-bottom:1px solid <?php echo e($color); ?>;">
                                                ...
                                                <div class="d-table-td w-4"><pre data-v-f2a183a6=""></pre></div>
                                                <div class="d-table-td w-5"><pre data-v-f2a183a6=""></pre></div>
                                                <div class="d-table-td w-4"><pre data-v-f2a183a6=""><?php echo e(__('Discount')); ?></pre></div>
                                                <?php if(!empty($posPayment->discount)): ?>
                                                <div class="d-table-td w-4"><span><?php echo e(Utility::priceFormat($settings,$posPayment->discount)); ?></span></div>
                                                <?php else: ?>
                                            ...
                                            <div class="d-table-tr" style="border-bottom:1px solid <?php echo e($color); ?>;">
                                                ...
                                                <div class="d-table-td w-4"><pre data-v-f2a183a6=""><?php echo e(__('Total')); ?></pre></div>
                                                <?php if(!empty($posPayment->discount)): ?>
                                                <div class="d-table-td w-4"><span><?php echo e(Utility::priceFormat($settings,$pos->totalRate + $pos->totalTaxPrice - $posPayment->discount)); ?></span></div>
                                                <?php else: ?>
                                                    <div class="d-table-td w-4"><span><?php echo e(Utility::priceFormat($settings,$pos->totalRate + $pos->totalTaxPrice )); ?></span></div>
...
<?php /**PATH C:\Users\Bdrango\Desktop\main_file\resources\views/pos/templates/template1.blade.php ENDPATH**/ ?>