                                ...
                                <ul class="list-group sortable">
                                    <?php $__currentLoopData = $task_stages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task_stage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li class="list-group-item" data-id="<?php echo e($task_stage->id); ?>">
                                            <span class="text-sm text-dark"><?php echo e($task_stage->name); ?></span>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Bdrango\Desktop\main_file\resources\views/task_stage/index.blade.php ENDPATH**/ ?>