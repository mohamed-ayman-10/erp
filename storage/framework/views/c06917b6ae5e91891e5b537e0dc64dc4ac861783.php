...
<head>
    <title>
        <?php echo e(Utility::getValByName('title_text') ? Utility::getValByName('title_text') : config('app.name', 'INOMERP')); ?>
...
<?php /**PATH C:\laragon\www\erpgo\resources\views/layouts/admin.blade.php ENDPATH**/ ?>