                            ...
                            <div class="col-auto float-end ms-2 mt-4">
                                ...
                                <a href="#" class="btn btn-sm btn-primary"
                                   ...
                                   data-toggle="tooltip" data-original-title="<?php echo e(__('apply')); ?>">
                                    ...
                                    <a href="<?php echo e(route('customer.index')); ?>" class="btn btn-sm btn-primary" data-toggle="tooltip"
                                                ...
                                                <?php $invoiceID= Crypt::encrypt($invoice->id); ?>
                                                    ...
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('copy invoice')): ?>
                                                        <div class="action-btn bg-warning ms-2">
                                                            <a href="#" id="<?php echo e(route('invoice.link.copy',[$invoiceID])); ?>" class="mx-3 btn btn-sm align-items-center"   onclick="copyToClipboard(this)" data-bs-toggle="tooltip" data-original-title="<?php echo e(__('Click to copy')); ?>"><i class="ti ti-link text-white"></i></a>
                                                        </div>
                                                    <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Bdrango\Desktop\main_file\resources\views/invoice/index.blade.php ENDPATH**/ ?>