...
<div class="modal-body">
    ...
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            <?php echo e(Form::date('start_date',null,['class' => 'form-control date', 'placeholder' => __('Select Date/Time'), 'required' => 'required'])); ?>
...
<?php /**PATH C:\Users\Bdrango\Desktop\main_file\resources\views/zoom-meeting/create.blade.php ENDPATH**/ ?>