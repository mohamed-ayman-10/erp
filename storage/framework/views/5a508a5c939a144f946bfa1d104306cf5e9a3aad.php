                ...
                <div class="card price-card price-1 wow animate__fadeInUp" data-wow-delay="0.2s" style="
                   ...
                   ">
                    <div class="card-body">
                        ...
                        <?php endif; ?>
                        <h1 class="mb-4 f-w-600 "><?php echo e((env('CURRENCY_SYMBOL') ? env('CURRENCY_SYMBOL') : '$')); ?><?php echo e(number_format($plan->price)); ?><small class="text-sm">/<?php echo e(__('Month')); ?></small></h1>
                        <p class="mb-0">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Bdrango\Desktop\main_file\resources\views/plan/index.blade.php ENDPATH**/ ?>