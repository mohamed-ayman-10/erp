                ...
                <div class="dropdown-menu dash-h-dropdown dropdown-menu-end">
                    ...
                    <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route('change.language', $language)); ?>"
                            class="dropdown-item <?php if($language == $lang): ?> text-danger <?php endif; ?>">
                    ...
                    <?php if(\Auth::user()->type == 'super admin'): ?>
                        <a class="dropdown-item text-primary"
                            href="<?php echo e(route('manage.language', [isset($lang) ? $lang : 'en'])); ?>"><?php echo e(__('Manage Language ')); ?></a>
                    <?php endif; ?>
                </div>
            </li>
        </ul>
...
<?php /**PATH C:\laragon\www\erpgo\resources\views/partials/admin/header.blade.php ENDPATH**/ ?>